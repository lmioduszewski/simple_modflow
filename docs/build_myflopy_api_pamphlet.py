...
PAGES = [
    ...
    },
    {
        ...
        "code": [
            ...
            "profile = model.plot.section(cells=[10, 20, 30], per=0)   # head vs distance",
            "",
            "# ... or the model itself in cross-section: grid, layers, results",
            "filled = model.plot.section(cells=[10, 20, 30], fill='layer', backend='mpl')",
            "",
