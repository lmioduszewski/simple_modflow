...
OUTPUT = ROOT / "simple_modflow_api_pamphlet.pdf"
...
PAGES = [
    ...
    },
    {
        ...
        "bullets": [
            ...
            "Package explorers now expose `get()`, `map()`, `plot_timeseries()`, and `plot_budget()` more consistently across LAK, SFR, and other namespaces.",
    ...
    },
    {
        ...
        "code": [
            ...
            "",
            "# build grouped package maps",
            "group.packages.surface_water.results.q.subplot_map(per=0)",
            "group.packages.lak.results.stage.plot_timeseries('lake_main')",
            "",
    ...
    },
    {
        ...
        "bullets": [
            "Use `ProjectCatalog`, `RunSpec`, and artifact helpers when you want managed related runs and reproducible scenario lineages.",
            "Use `load_mf6_run(...)` and `RunExplorer` when you want to lazily inspect existing archives without rebuilding models.",
        ...
        "code": [
            ...
            "explorer = mf.RunExplorer.from_directory(root)",
            "",
            "# organize related runs when lineage matters",
            "catalog = mf.ProjectCatalog(root=project_root)",
...
def draw_header(c: canvas.Canvas, page, page_no: int, styles):
    ...
    c.drawString(36, 6, "simple_modflow workflow pamphlet")
