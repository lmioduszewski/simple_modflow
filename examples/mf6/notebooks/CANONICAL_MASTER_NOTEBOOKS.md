...
These notebooks are the authoritative end-to-end examples for `simple_modflow`.
...
5. `canonical_04_pest_and_results.ipynb`: calibration setup and completed-run review.
