...
- :mod:`simple_modflow.modflow.mf6.budget_tables`
- :mod:`simple_modflow.modflow.mf6.budget_plotting`

The public classes here are intentionally compatibility-oriented wrappers. They
retain the established `simple_modflow` calling style while sharing common
...
from simple_modflow.modflow.mf6.budget_plotting import (
...
from simple_modflow.modflow.mf6.budget_tables import (
...
class Budget:
    ...
    grid conventions and the rest of ``simple_modflow``.
    """
