...
class PRTRunResults:
    ...
    def scene(self, **kwargs):
        from simple_modflow.modflow.mf6.interactive_plotting import build_particle_tracking_scene

        return build_particle_tracking_scene(self.flow_model, self.pathlines, **kwargs)

    def plot_map(self, **kwargs):
        from simple_modflow.modflow.mf6.interactive_plotting import plot_particle_pathlines
    ...
    def export_3d_html(self, output_path: str | Path, **kwargs) -> Path:
        from simple_modflow.modflow.mf6.interactive_plotting import export_particle_tracking_html
...
class ParticleTracking:
    ...
    def mp3du(self, particles, **kwargs):
        from simple_modflow.modflow.mp3du import prepare_particle_tracking
