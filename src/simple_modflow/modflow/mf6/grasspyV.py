...
if __name__ == '__main__':
    ...
    botm_aq = Path(r"C:\Users\lukem\mf6\Cumberland general\Surfaces\bottom_of_aq_FINAL_v11.gpkg").as_posix()
    region_raster = Path(r"C:\Users\lukem\mf6\Cumberland general\Surfaces\top_of_model_with_pits_no_overlap_with_botm_v5.tif").as_posix()
    interp = SurfaceInterpFromShp(
        shp_gpkg_path=botm_aq,
        region_dimensions_raster=region_raster,
        shp_attribute_for_z='Elev',
        output_resolution=20,
        surf_out='cumb_aq_btm_v11.tif',
        epsg='2926'
    )
    interp.write_surf()
