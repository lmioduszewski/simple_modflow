...
class SurfaceInterpFromShp:
    ...
    def __init__(
        ...
        """
        self.grass8bin = Path(r"C:\Users\lukem\AppData\Local\Programs\OSGeo4W\bin\grass84.bat")
...
if __name__ == '__main__':
    ...
    botm_aq = Path(r"C:\Users\lukem\QGIS\SHP\Hydro\Lake Sawyer Bathymetry.gpkg").as_posix()
    region_raster = Path(r"C:\Users\lukem\QGIS\RASTER\Ten Trails\lake sawyer region.tif").as_posix()
    interp = SurfaceInterpFromShp(
        shp_gpkg_path=botm_aq,
        region_dimensions_raster=region_raster,
        shp_attribute_for_z='elev',
        output_resolution=10,
        surf_out='lake sawyer bathy.tif',
        epsg='2927'
    )
    interp.write_surf()
