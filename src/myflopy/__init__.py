...
_EXPORTS = {
    ...
    "dis": ("myflopy.package_api", "dis"),
    "disu": ("myflopy.package_api", "disu"),
    ...
    "evt": ("myflopy.package_api", "evt"),
    "wel": ("myflopy.package_api", "wel"),
    "prt": ("myflopy.package_api", "prt"),
    "rch": ("myflopy.package_api", "rch"),
    "riv": ("myflopy.package_api", "riv"),
    "uzf": ("myflopy.package_api", "uzf"),
    "sfr": ("myflopy.package_api", "sfr"),
    "lak": ("myflopy.package_api", "lak"),
    "mvr": ("myflopy.package_api", "mvr"),
    "adv": ("myflopy.package_api", "adv"),
    "dsp": ("myflopy.package_api", "dsp"),
    "mst": ("myflopy.package_api", "mst"),
    "ist": ("myflopy.package_api", "ist"),
    "ssm": ("myflopy.package_api", "ssm"),
    "cnc": ("myflopy.package_api", "cnc"),
    "src": ("myflopy.package_api", "src"),
    "est": ("myflopy.package_api", "est"),
    "cnd": ("myflopy.package_api", "cnd"),
    "ctp": ("myflopy.package_api", "ctp"),
    "esl": ("myflopy.package_api", "esl"),
    "ems": ("myflopy.package_api", "ems"),
    "mip": ("myflopy.package_api", "mip"),
    "prp": ("myflopy.package_api", "prp"),
    ...
    "evt_spec": ("myflopy.advanced", "evt_spec"),
    ...
    "riv_spec": ("myflopy.advanced", "riv_spec"),
...
__compatibility__ = (
    ...
    "myflopy.modflow.mf6.package_surface_water.LakBudgetResultsExplorer.budget_summary",
    "myflopy.modflow.mf6.package_surface_water.LakBudgetResultsExplorer.plot_budget",
    "myflopy.modflow.mf6.package_surface_water.SfrBudgetResultsExplorer.plot_profile",
    ...
    "myflopy.modflow.mf6.package_surface_water.SfrStageResultsExplorer.plot_profile",
